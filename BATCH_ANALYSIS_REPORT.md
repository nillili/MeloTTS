...
|------|--------|---------|-----------|------|
| 1 | 테스트문서2.pdf | 37개 | 2.3시간 (138분) | ✅ 성공 |
| 2 | 테스트문서3.pdf | 40개 | 2.5시간 (148분) | ✅ 성공 |
| 3 | 테스트문서4.pdf | 39개 | 2.5시간 (149분) | ✅ 성공 |
| 4 | 테스트문서5.pdf | 41개 | 2.5시간 (150분) | ✅ 성공 |
| 5 | 테스트문서6.pdf | 74개 | 4.6시간 (274분) | ✅ 성공 |
| **합계** | - | **231개** | **14.3시간** | **100%** |
...
| 파일 | 시작 | 종료 | 증가량 | 상태 |
|------|------|------|--------|------|
| 테스트문서2.pdf | 1,136 MB | 2,462 MB | +1,326 MB | ⚠️ 초기 로드 |
| 테스트문서3.pdf | 2,461 MB | 2,475 MB | +14 MB | ✅ 안정 |
| 테스트문서4.pdf | 2,475 MB | 2,494 MB | +19 MB | ✅ 안정 |
| 테스트문서5.pdf | 2,494 MB | 2,551 MB | +57 MB | ✅ 안정 |
| 테스트문서6.pdf | 2,551 MB | 2,561 MB | +10 MB | ✅ 안정 |
...
|------|---------------|------|
| 시작 | 63.2% | ✅ 안전 |
| 테스트문서2 처리 중 | 78-80% | ✅ 정상 |
| 테스트문서3-5 처리 중 | 70-72% | ✅ 안정 |
| 테스트문서6 처리 중 | 72-74% | ✅ 안정 |
| 종료 | 74.0% | ✅ 안전 |
...
### 청크 수에 따른 처리 시간
- 테스트문서6.pdf (74 청크): 274분 → **청크당 3.7분**
- 테스트문서2.pdf (37 청크): 138분 → **청크당 3.7분**
- 일관된 처리 속도: ✅ **성능 안정적**
